export default {
  ...
  matrix: {
    ...
    q9: { answer: false, comment: 'Transactions are processed through an account generated per investor in each coin\'s respective network (except XLM and XRP that use different memos generation).' },
