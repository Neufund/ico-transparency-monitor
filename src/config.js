...
const zrx = {
  ...
  matrix: {
    ...
    q3: {answer: true},
    q4: {answer: true},
    q5: {answer: false, comment: 'Crowdsale contract provides no tracking data. Actual value of ZXR amount  per ETH amount for given investor is never logged. Could be better.'},
    q6: {answer: true},
    q7: {answer: true},
    q8: {answer: null},
    q9: {answer: null},
    q10: {answer: true},
    q11: {answer: true, comment: 'Crowdsale happens via 0x exchange. The maker of the order is a simple address so order could be cancelled any time. Could be better but not enough to fail.'},
    q12: {answer: true},
    q13: {answer: true},
    q14: {answer: false, comment: 'See Q11. Maker can cancel the order any time thus ending ICO.'},
  },
  decimals: 18,
  addedBy: 'Rudolfix',
};
