...
## How it works
Every transaction that occurs in the network is loged in the public etheruem leger. Smart-Contracts when executed generate diffrent events based on how they are programed and the action they execute. 
