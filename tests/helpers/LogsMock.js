...
export default address => {
  ...
  const getLogTemplate = (eventName , index) => ({
    ...
    blockHash:"0xe75c5b4dcb19d1d05b99704987ea4a5385c2e3093fec623646f8585e16a36963",
    blockNumber:3939554,
    event:eventName,
    logIndex:index,
    timestamp:1498598604*index,
    transactionHash:"0xd140ef0d51db7c9e1dd237f80db78520352e6909f7a4b1b13653a355c5222e87",
    transactionIndex:31,
  ...
  eventNames.forEach(eventName => {
    for ( let i = 1 ; i <= 3 ; i ++ ) {
      if (!logs.hasOwnProperty(eventName))
        logs[eventName] = [];
