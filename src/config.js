    ...
    'filescoin-smart-contract-not-provided': {
      ...
      matrix: {
        q1: { answer: false, comment:
          ...
          + "HD wallets are created for participants (BIP32 we assume) which are probably monitored by backend that can derive priv keys to control funds. "
        ...
        q7: { answer: false},
        q8: { answer: false, comment: "Fiat is entirelly handled by banks, no pegged token of any kind is used, that eliminates fiat from any kind of auditing." },
        q9: { answer: false},
        q10: { answer: null },
        q11: { answer: null },
