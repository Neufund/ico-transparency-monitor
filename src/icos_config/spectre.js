...
export default {
  ...
  matrix: {
    ...
    q8: { answer: true },
    q9: { answer: true },
    q10: { answer: false, comment: `Contract code is messy. 50% of the code could be removed. Standard transfer functions are overriden 
      and never used. Why TokenControlled is implemented when no one controlls anything and internal interface is not used etc.?` },
