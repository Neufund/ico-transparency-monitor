...
export default {
  crowdSaleTokenContract: '0xB5d4baeaD54821862Dc8e732B9F86DeB489dd04e',
  tokenContract: '0x9a005c9a89bd72a4bd27721e7a09a3c11d2b03c4',
  information: {
    name: 'STC',
  ...
  icoParameters: {
    cap: async (web3, icoContract) => {
      ...
      return `${formatNumber(convertWeb3Value(tokensLeft.add(tokensSold), 'ether'))} STC`;
    },
